...
namespace RefreshingCache
{
    public class RefreshingCache<TKey, TValue> : IDataStorage<TKey, TValue>
    {
        ...
        //move after ' GetData(TKey key)' method
        ...
        //move after 'TValue this[TKey key]' method
        ...
        //move after 'this[TKey key]' method
        public TValue GetData(TKey key)
        {
            return this[key];
        }

        //move after 'AddData(TKey key, TValue value)' method
