...
namespace SkillTreeTest
{
    ...
    public class GraphTest
    {
        ...
        public void AddVertex_NameCleenCode()
        {
            ...
            Assert.AreEqual("CleanCode", graph.FindVertex("CleanCode").Skill.Name);
        }
        [TestMethod]
        public void AddVertex_throwInvalidOperationException_RepeatName()
        {
            var graph = new Graph();
            var skillfirst = new Skill("CleanCode", "Hard", "imp", 10);
            var skillsecond = new Skill("CleanCode", "easy", "noimp", 20);
        ...
        public void FindVertex_NotFound_ReturnNull()
        {
            ...
            Assert.IsNull(graph.FindVertex("CleanCode"));
        }
        [TestMethod]
        public void AddEdge_NameRefactoringNameCleenCode()
        {
            ...
            Assert.AreEqual("CleanCode", graph.FindVertex("Refactoring").Edges[0].ConnectedVertex.Skill.Name);
        }
        [TestMethod]
        ...
        public void AddEdge_throwInvalidOperationExceptionFirst_FirstNameNotFound()
        {
            ...
            Assert.ThrowsException<InvalidOperationException>(() => graph.AddEdge("Refactoring", "CleanCode"));
        }
        [TestMethod]
