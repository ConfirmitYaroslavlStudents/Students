namespace HelpKsyu
{
	partial class HelpKsyuMainWindow
	{
		...
		private void InitializeComponent()
		{
			...
			this.DsplForGraph = new Tao.Platform.Windows.SimpleOpenGlControl();
			...
			// DsplForGraph
			// 
			this.DsplForGraph.AccumBits = ((byte)(0));
			this.DsplForGraph.AutoCheckErrors = false;
			this.DsplForGraph.AutoFinish = false;
			this.DsplForGraph.AutoMakeCurrent = true;
			this.DsplForGraph.AutoSwapBuffers = true;
			this.DsplForGraph.BackColor = System.Drawing.Color.Black;
			this.DsplForGraph.ColorBits = ((byte)(32));
			this.DsplForGraph.DepthBits = ((byte)(16));
			this.DsplForGraph.Location = new System.Drawing.Point(12, 65);
			this.DsplForGraph.Name = "DsplForGraph";
			this.DsplForGraph.Size = new System.Drawing.Size(760, 760);
			this.DsplForGraph.StencilBits = ((byte)(0));
			this.DsplForGraph.TabIndex = 0;
			// 
			// ShowGraphs
			// 
			...
			this.Controls.Add(this.DsplForGraph);
		...
		private Tao.Platform.Windows.SimpleOpenGlControl DsplForGraph;
