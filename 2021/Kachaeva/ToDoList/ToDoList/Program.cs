...
namespace ToDoListProject
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            var consoleLogger = new ConsoleWriterReader();
            var controller = new ConsoleController(fileWorkHandler, consoleLogger);
            ...
            //        if (selectedAction == "q")
            //        {
            //            fileWorkHandler.SaveToDoListToFile(toDoList, fileName);
            //            break;
            //        }
