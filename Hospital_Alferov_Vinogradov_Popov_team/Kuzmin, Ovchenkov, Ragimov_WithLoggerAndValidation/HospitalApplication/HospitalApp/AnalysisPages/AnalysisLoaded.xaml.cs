...
namespace HospitalApp.AnalysisPages
{
    ...
    public partial class AnalysisLoaded
    {
        ...
        {
            Analysis analysis = CurrentState.CurrentAnalysis;
            Person person = CurrentState.CurrentPerson;

            string result = person.Id + "_" + person.FirstName + "_" + person.LastName +
        ...
        private void ChangeOpacity(Button control, int speed, bool fade = true)
        {
            ...
            else
            {
                ...
                storyboard.Completed += (s, ea) => { control.Style = (Style) FindResource("RoundCorner"); };
            }
