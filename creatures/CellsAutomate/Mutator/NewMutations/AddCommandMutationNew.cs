...
{
    public class AddCommandMutationNew : IMutationNew
    {
        ...
        public AddCommandMutationNew(Random random, ICommandsList commands)
        {
            _random = random;
            _commands = commands;
        ...
        {
            AddConditionBlock(insertIndex, _random.Next(insertIndex + 1, _commands.Count + 2));
        }
