...
namespace QueueTests
{
    ...
    public abstract class QueueTestsBaseQueueIsNotEmpty
    {
        ...
        /// </summary>
        /// <returns></returns>
        protected abstract IQueue<int> GetFullQueueInstance();
        ...
        {
            // arrange
            IQueue<int> testQueue = GetFullQueueInstance();
            string actual = null;
        ...
        {
            // arrange
            IQueue<int> actual = GetEmptyQueueInstance();
        ...
        {
            // arrange
            IQueue<int> testQueue = GetEmptyQueueInstance();
            string actual = null;
    ...
    {
        protected override IQueue<int> GetFullQueueInstance()
        {
